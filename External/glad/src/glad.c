...
static void glad_gl_load_GL_AMD_draw_buffers_blend(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glBlendFuncSeparateIndexedAMD = (PFNGLBLENDFUNCSEPARATEINDEXEDAMDPROC) load(
...
static void glad_gl_load_GL_AMD_framebuffer_multisample_advanced(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glNamedRenderbufferStorageMultisampleAdvancedAMD = (PFNGLNAMEDRENDERBUFFERSTORAGEMULTISAMPLEADVANCEDAMDPROC)
            load(userptr, "glNamedRenderbufferStorageMultisampleAdvancedAMD");
...
static void glad_gl_load_GL_AMD_interleaved_elements(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glVertexAttribParameteriAMD = (PFNGLVERTEXATTRIBPARAMETERIAMDPROC)
            load(userptr, "glVertexAttribParameteriAMD");
}
...
static void glad_gl_load_GL_AMD_occlusion_query_event(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glQueryObjectParameteruiAMD = (PFNGLQUERYOBJECTPARAMETERUIAMDPROC)
            load(userptr, "glQueryObjectParameteruiAMD");
}
...
static void glad_gl_load_GL_AMD_performance_monitor(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glGetPerfMonitorCountersAMD = (PFNGLGETPERFMONITORCOUNTERSAMDPROC)
            load(userptr, "glGetPerfMonitorCountersAMD");
...
static void glad_gl_load_GL_APPLE_flush_buffer_range(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glFlushMappedBufferRangeAPPLE = (PFNGLFLUSHMAPPEDBUFFERRANGEAPPLEPROC) load(
...
static void glad_gl_load_GL_APPLE_object_purgeable(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glGetObjectParameterivAPPLE = (PFNGLGETOBJECTPARAMETERIVAPPLEPROC)
            load(userptr, "glGetObjectParameterivAPPLE");
...
static void glad_gl_load_GL_ARB_bindless_texture(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glProgramUniformHandleui64ARB = (PFNGLPROGRAMUNIFORMHANDLEUI64ARBPROC) load(
...
static void glad_gl_load_GL_ARB_compute_variable_group_size(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glDispatchComputeGroupSizeARB = (PFNGLDISPATCHCOMPUTEGROUPSIZEARBPROC) load(
...
static void glad_gl_load_GL_ARB_draw_buffers_blend(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glBlendEquationSeparateiARB = (PFNGLBLENDEQUATIONSEPARATEIARBPROC)
            load(userptr, "glBlendEquationSeparateiARB");
...
static void glad_gl_load_GL_ARB_fragment_program(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glGetProgramEnvParameterdvARB = (PFNGLGETPROGRAMENVPARAMETERDVARBPROC) load(
        userptr, "glGetProgramEnvParameterdvARB");
    glad_glGetProgramEnvParameterfvARB = (PFNGLGETPROGRAMENVPARAMETERFVARBPROC) load(
    ...
    glad_glProgramEnvParameter4dvARB = (PFNGLPROGRAMENVPARAMETER4DVARBPROC)
            load(userptr, "glProgramEnvParameter4dvARB");
    glad_glProgramEnvParameter4fARB = (PFNGLPROGRAMENVPARAMETER4FARBPROC) load(userptr, "glProgramEnvParameter4fARB");
    glad_glProgramEnvParameter4fvARB = (PFNGLPROGRAMENVPARAMETER4FVARBPROC)
            load(userptr, "glProgramEnvParameter4fvARB");
    glad_glProgramLocalParameter4dARB = (PFNGLPROGRAMLOCALPARAMETER4DARBPROC) load(
        userptr, "glProgramLocalParameter4dARB");
    glad_glProgramLocalParameter4dvARB = (PFNGLPROGRAMLOCALPARAMETER4DVARBPROC) load(
    ...
    glad_glProgramLocalParameter4fvARB = (PFNGLPROGRAMLOCALPARAMETER4FVARBPROC) load(
...
static void glad_gl_load_GL_ARB_geometry_shader4(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glFramebufferTextureFaceARB = (PFNGLFRAMEBUFFERTEXTUREFACEARBPROC)
            load(userptr, "glFramebufferTextureFaceARB");
...
static void glad_gl_load_GL_ARB_imaging(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glGetConvolutionParameterfv = (PFNGLGETCONVOLUTIONPARAMETERFVPROC)
            load(userptr, "glGetConvolutionParameterfv");
    glad_glGetConvolutionParameteriv = (PFNGLGETCONVOLUTIONPARAMETERIVPROC)
...
static void glad_gl_load_GL_ARB_parallel_shader_compile(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glMaxShaderCompilerThreadsARB = (PFNGLMAXSHADERCOMPILERTHREADSARBPROC) load(
...
static void glad_gl_load_GL_ARB_robustness(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glGetGraphicsResetStatusARB = (PFNGLGETGRAPHICSRESETSTATUSARBPROC)
            load(userptr, "glGetGraphicsResetStatusARB");
    glad_glGetnColorTableARB = (PFNGLGETNCOLORTABLEARBPROC) load(userptr, "glGetnColorTableARB");
    glad_glGetnCompressedTexImageARB = (PFNGLGETNCOMPRESSEDTEXIMAGEARBPROC)
            load(userptr, "glGetnCompressedTexImageARB");
...
static void glad_gl_load_GL_ARB_vertex_program(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glBindProgramARB = (PFNGLBINDPROGRAMARBPROC) load(userptr, "glBindProgramARB");
    glad_glDeleteProgramsARB = (PFNGLDELETEPROGRAMSARBPROC) load(userptr, "glDeleteProgramsARB");
    glad_glDisableVertexAttribArrayARB = (PFNGLDISABLEVERTEXATTRIBARRAYARBPROC) load(
...
static void glad_gl_load_GL_ATI_vertex_streams(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glClientActiveVertexStreamATI = (PFNGLCLIENTACTIVEVERTEXSTREAMATIPROC) load(
...
static void glad_gl_load_GL_EXT_EGL_image_storage(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glEGLImageTargetTexStorageEXT = (PFNGLEGLIMAGETARGETTEXSTORAGEEXTPROC) load(
...
static void glad_gl_load_GL_EXT_convolution(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glConvolutionParameterfvEXT = (PFNGLCONVOLUTIONPARAMETERFVEXTPROC)
            load(userptr, "glConvolutionParameterfvEXT");
    glad_glConvolutionParameteriEXT = (PFNGLCONVOLUTIONPARAMETERIEXTPROC) load(userptr, "glConvolutionParameteriEXT");
    glad_glConvolutionParameterivEXT = (PFNGLCONVOLUTIONPARAMETERIVEXTPROC)
            load(userptr, "glConvolutionParameterivEXT");
...
static void glad_gl_load_GL_EXT_direct_state_access(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glCompressedTextureImage1DEXT = (PFNGLCOMPRESSEDTEXTUREIMAGE1DEXTPROC) load(
        userptr, "glCompressedTextureImage1DEXT");
    glad_glCompressedTextureImage2DEXT = (PFNGLCOMPRESSEDTEXTUREIMAGE2DEXTPROC) load(
        userptr, "glCompressedTextureImage2DEXT");
    glad_glCompressedTextureImage3DEXT = (PFNGLCOMPRESSEDTEXTUREIMAGE3DEXTPROC) load(
    ...
    glad_glCopyMultiTexSubImage1DEXT = (PFNGLCOPYMULTITEXSUBIMAGE1DEXTPROC)
            load(userptr, "glCopyMultiTexSubImage1DEXT");
    glad_glCopyMultiTexSubImage2DEXT = (PFNGLCOPYMULTITEXSUBIMAGE2DEXTPROC)
            load(userptr, "glCopyMultiTexSubImage2DEXT");
    glad_glCopyMultiTexSubImage3DEXT = (PFNGLCOPYMULTITEXSUBIMAGE3DEXTPROC)
            load(userptr, "glCopyMultiTexSubImage3DEXT");
    ...
    glad_glDisableVertexArrayAttribEXT = (PFNGLDISABLEVERTEXARRAYATTRIBEXTPROC) load(
    ...
    glad_glEnableClientStateIndexedEXT = (PFNGLENABLECLIENTSTATEINDEXEDEXTPROC) load(
    ...
    glad_glFramebufferDrawBuffersEXT = (PFNGLFRAMEBUFFERDRAWBUFFERSEXTPROC)
            load(userptr, "glFramebufferDrawBuffersEXT");
    glad_glFramebufferReadBufferEXT = (PFNGLFRAMEBUFFERREADBUFFEREXTPROC) load(userptr, "glFramebufferReadBufferEXT");
    glad_glGenerateMultiTexMipmapEXT = (PFNGLGENERATEMULTITEXMIPMAPEXTPROC)
            load(userptr, "glGenerateMultiTexMipmapEXT");
    ...
    glad_glGetMultiTexParameterIuivEXT = (PFNGLGETMULTITEXPARAMETERIUIVEXTPROC) load(
        userptr, "glGetMultiTexParameterIuivEXT");
    glad_glGetMultiTexParameterfvEXT = (PFNGLGETMULTITEXPARAMETERFVEXTPROC)
            load(userptr, "glGetMultiTexParameterfvEXT");
    glad_glGetMultiTexParameterivEXT = (PFNGLGETMULTITEXPARAMETERIVEXTPROC)
            load(userptr, "glGetMultiTexParameterivEXT");
    glad_glGetNamedBufferParameterivEXT = (PFNGLGETNAMEDBUFFERPARAMETERIVEXTPROC) load(
        userptr, "glGetNamedBufferParameterivEXT");
    glad_glGetNamedBufferPointervEXT = (PFNGLGETNAMEDBUFFERPOINTERVEXTPROC)
            load(userptr, "glGetNamedBufferPointervEXT");
    ...
    glad_glGetTextureParameterIivEXT = (PFNGLGETTEXTUREPARAMETERIIVEXTPROC)
            load(userptr, "glGetTextureParameterIivEXT");
    ...
    glad_glGetVertexArrayIntegeri_vEXT = (PFNGLGETVERTEXARRAYINTEGERI_VEXTPROC) load(
        userptr, "glGetVertexArrayIntegeri_vEXT");
    glad_glGetVertexArrayIntegervEXT = (PFNGLGETVERTEXARRAYINTEGERVEXTPROC)
            load(userptr, "glGetVertexArrayIntegervEXT");
    glad_glGetVertexArrayPointeri_vEXT = (PFNGLGETVERTEXARRAYPOINTERI_VEXTPROC) load(
        userptr, "glGetVertexArrayPointeri_vEXT");
    glad_glGetVertexArrayPointervEXT = (PFNGLGETVERTEXARRAYPOINTERVEXTPROC)
            load(userptr, "glGetVertexArrayPointervEXT");
    ...
    glad_glNamedCopyBufferSubDataEXT = (PFNGLNAMEDCOPYBUFFERSUBDATAEXTPROC)
            load(userptr, "glNamedCopyBufferSubDataEXT");
    ...
    glad_glNamedRenderbufferStorageEXT = (PFNGLNAMEDRENDERBUFFERSTORAGEEXTPROC) load(
    ...
    glad_glVertexArrayColorOffsetEXT = (PFNGLVERTEXARRAYCOLOROFFSETEXTPROC)
            load(userptr, "glVertexArrayColorOffsetEXT");
    ...
    glad_glVertexArrayIndexOffsetEXT = (PFNGLVERTEXARRAYINDEXOFFSETEXTPROC)
...
static void glad_gl_load_GL_EXT_fragment_shading_rate(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glFramebufferShadingRateEXT = (PFNGLFRAMEBUFFERSHADINGRATEEXTPROC)
            load(userptr, "glFramebufferShadingRateEXT");
    glad_glGetFragmentShadingRatesEXT = (PFNGLGETFRAGMENTSHADINGRATESEXTPROC) load(
        userptr, "glGetFragmentShadingRatesEXT");
    glad_glShadingRateCombinerOpsEXT = (PFNGLSHADINGRATECOMBINEROPSEXTPROC)
            load(userptr, "glShadingRateCombinerOpsEXT");
...
static void glad_gl_load_GL_EXT_framebuffer_object(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glCheckFramebufferStatusEXT = (PFNGLCHECKFRAMEBUFFERSTATUSEXTPROC)
            load(userptr, "glCheckFramebufferStatusEXT");
...
static void glad_gl_load_GL_EXT_mesh_shader(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glMultiDrawMeshTasksIndirectCountEXT = (PFNGLMULTIDRAWMESHTASKSINDIRECTCOUNTEXTPROC) load(
        userptr, "glMultiDrawMeshTasksIndirectCountEXT");
    glad_glMultiDrawMeshTasksIndirectEXT = (PFNGLMULTIDRAWMESHTASKSINDIRECTEXTPROC) load(
...
static void glad_gl_load_GL_EXT_paletted_texture(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glGetColorTableParameterfvEXT = (PFNGLGETCOLORTABLEPARAMETERFVEXTPROC) load(
        userptr, "glGetColorTableParameterfvEXT");
    glad_glGetColorTableParameterivEXT = (PFNGLGETCOLORTABLEPARAMETERIVEXTPROC) load(
...
static void glad_gl_load_GL_EXT_pixel_transform(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glPixelTransformParameterfEXT = (PFNGLPIXELTRANSFORMPARAMETERFEXTPROC) load(
    ...
    glad_glPixelTransformParameteriEXT = (PFNGLPIXELTRANSFORMPARAMETERIEXTPROC) load(
...
static void glad_gl_load_GL_EXT_semaphore_win32(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glImportSemaphoreWin32NameEXT = (PFNGLIMPORTSEMAPHOREWIN32NAMEEXTPROC) load(
...
static void glad_gl_load_GL_EXT_transform_feedback(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glBeginTransformFeedbackEXT = (PFNGLBEGINTRANSFORMFEEDBACKEXTPROC)
            load(userptr, "glBeginTransformFeedbackEXT");
...
static void glad_gl_load_GL_EXT_vertex_shader(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glBindTextureUnitParameterEXT = (PFNGLBINDTEXTUREUNITPARAMETEREXTPROC) load(
    ...
    glad_glEnableVariantClientStateEXT = (PFNGLENABLEVARIANTCLIENTSTATEEXTPROC) load(
    ...
    glad_glGetLocalConstantBooleanvEXT = (PFNGLGETLOCALCONSTANTBOOLEANVEXTPROC) load(
        userptr, "glGetLocalConstantBooleanvEXT");
    glad_glGetLocalConstantFloatvEXT = (PFNGLGETLOCALCONSTANTFLOATVEXTPROC)
            load(userptr, "glGetLocalConstantFloatvEXT");
    glad_glGetLocalConstantIntegervEXT = (PFNGLGETLOCALCONSTANTINTEGERVEXTPROC) load(
...
static void glad_gl_load_GL_EXT_win32_keyed_mutex(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glAcquireKeyedMutexWin32EXT = (PFNGLACQUIREKEYEDMUTEXWIN32EXTPROC)
            load(userptr, "glAcquireKeyedMutexWin32EXT");
    glad_glReleaseKeyedMutexWin32EXT = (PFNGLRELEASEKEYEDMUTEXWIN32EXTPROC)
...
static void glad_gl_load_GL_HP_image_transform(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glImageTransformParameterfvHP = (PFNGLIMAGETRANSFORMPARAMETERFVHPPROC) load(
    ...
    glad_glImageTransformParameterivHP = (PFNGLIMAGETRANSFORMPARAMETERIVHPPROC) load(
...
static void glad_gl_load_GL_INTEL_performance_query(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glGetPerfQueryIdByNameINTEL = (PFNGLGETPERFQUERYIDBYNAMEINTELPROC)
            load(userptr, "glGetPerfQueryIdByNameINTEL");
...
static void glad_gl_load_GL_KHR_parallel_shader_compile(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glMaxShaderCompilerThreadsKHR = (PFNGLMAXSHADERCOMPILERTHREADSKHRPROC) load(
...
static void glad_gl_load_GL_MESA_framebuffer_flip_y(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glFramebufferParameteriMESA = (PFNGLFRAMEBUFFERPARAMETERIMESAPROC)
            load(userptr, "glFramebufferParameteriMESA");
...
static void glad_gl_load_GL_MESA_map_buffer_client_pointer(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glAddClientPointerRangeMESA = (PFNGLADDCLIENTPOINTERRANGEMESAPROC)
            load(userptr, "glAddClientPointerRangeMESA");
    glad_glReleaseClientPointerRangeMESA = (PFNGLRELEASECLIENTPOINTERRANGEMESAPROC) load(
...
static void glad_gl_load_GL_NVX_conditional_render(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glBeginConditionalRenderNVX = (PFNGLBEGINCONDITIONALRENDERNVXPROC)
            load(userptr, "glBeginConditionalRenderNVX");
...
static void glad_gl_load_GL_NVX_gpu_multicast2(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glAsyncCopyBufferSubDataNVX = (PFNGLASYNCCOPYBUFFERSUBDATANVXPROC)
    ...
    glad_glMulticastScissorArrayvNVX = (PFNGLMULTICASTSCISSORARRAYVNVXPROC)
            load(userptr, "glMulticastScissorArrayvNVX");
...
static void glad_gl_load_GL_NVX_linked_gpu_multicast(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glLGPUNamedBufferSubDataNVX = (PFNGLLGPUNAMEDBUFFERSUBDATANVXPROC)
            load(userptr, "glLGPUNamedBufferSubDataNVX");
}
...
static void glad_gl_load_GL_NV_bindless_texture(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glGetTextureSamplerHandleNV = (PFNGLGETTEXTURESAMPLERHANDLENVPROC)
            load(userptr, "glGetTextureSamplerHandleNV");
    glad_glIsImageHandleResidentNV = (PFNGLISIMAGEHANDLERESIDENTNVPROC) load(userptr, "glIsImageHandleResidentNV");
    glad_glIsTextureHandleResidentNV = (PFNGLISTEXTUREHANDLERESIDENTNVPROC)
            load(userptr, "glIsTextureHandleResidentNV");
    ...
    glad_glMakeTextureHandleResidentNV = (PFNGLMAKETEXTUREHANDLERESIDENTNVPROC) load(
    ...
    glad_glProgramUniformHandleui64vNV = (PFNGLPROGRAMUNIFORMHANDLEUI64VNVPROC) load(
...
static void glad_gl_load_GL_NV_command_list(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glDrawCommandsStatesAddressNV = (PFNGLDRAWCOMMANDSSTATESADDRESSNVPROC) load(
...
static void glad_gl_load_GL_NV_evaluators(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glGetMapAttribParameterfvNV = (PFNGLGETMAPATTRIBPARAMETERFVNVPROC)
            load(userptr, "glGetMapAttribParameterfvNV");
    glad_glGetMapAttribParameterivNV = (PFNGLGETMAPATTRIBPARAMETERIVNVPROC)
            load(userptr, "glGetMapAttribParameterivNV");
...
static void glad_gl_load_GL_NV_fragment_program(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glProgramNamedParameter4dNV = (PFNGLPROGRAMNAMEDPARAMETER4DNVPROC)
            load(userptr, "glProgramNamedParameter4dNV");
    glad_glProgramNamedParameter4dvNV = (PFNGLPROGRAMNAMEDPARAMETER4DVNVPROC) load(
        userptr, "glProgramNamedParameter4dvNV");
    glad_glProgramNamedParameter4fNV = (PFNGLPROGRAMNAMEDPARAMETER4FNVPROC)
            load(userptr, "glProgramNamedParameter4fNV");
...
static void glad_gl_load_GL_NV_framebuffer_mixed_samples(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glCoverageModulationTableNV = (PFNGLCOVERAGEMODULATIONTABLENVPROC)
            load(userptr, "glCoverageModulationTableNV");
...
static void glad_gl_load_GL_NV_geometry_program4(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glFramebufferTextureFaceEXT = (PFNGLFRAMEBUFFERTEXTUREFACEEXTPROC)
            load(userptr, "glFramebufferTextureFaceEXT");
    glad_glFramebufferTextureLayerEXT = (PFNGLFRAMEBUFFERTEXTURELAYEREXTPROC) load(
        userptr, "glFramebufferTextureLayerEXT");
...
static void glad_gl_load_GL_NV_gpu_multicast(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glMulticastCopyImageSubDataNV = (PFNGLMULTICASTCOPYIMAGESUBDATANVPROC) load(
    ...
    glad_glMulticastGetQueryObjectivNV = (PFNGLMULTICASTGETQUERYOBJECTIVNVPROC) load(
...
static void glad_gl_load_GL_NV_gpu_program4(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glGetProgramEnvParameterIivNV = (PFNGLGETPROGRAMENVPARAMETERIIVNVPROC) load(
    ...
    glad_glProgramEnvParameterI4ivNV = (PFNGLPROGRAMENVPARAMETERI4IVNVPROC)
            load(userptr, "glProgramEnvParameterI4ivNV");
    glad_glProgramEnvParameterI4uiNV = (PFNGLPROGRAMENVPARAMETERI4UINVPROC)
            load(userptr, "glProgramEnvParameterI4uiNV");
    ...
    glad_glProgramEnvParametersI4uivNV = (PFNGLPROGRAMENVPARAMETERSI4UIVNVPROC) load(
    ...
    glad_glProgramLocalParameterI4ivNV = (PFNGLPROGRAMLOCALPARAMETERI4IVNVPROC) load(
        userptr, "glProgramLocalParameterI4ivNV");
    glad_glProgramLocalParameterI4uiNV = (PFNGLPROGRAMLOCALPARAMETERI4UINVPROC) load(
...
static void glad_gl_load_GL_NV_internalformat_sample_query(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glGetInternalformatSampleivNV = (PFNGLGETINTERNALFORMATSAMPLEIVNVPROC) load(
...
static void glad_gl_load_GL_NV_memory_attachment(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glNamedBufferAttachMemoryNV = (PFNGLNAMEDBUFFERATTACHMEMORYNVPROC)
            load(userptr, "glNamedBufferAttachMemoryNV");
...
static void glad_gl_load_GL_NV_memory_object_sparse(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glBufferPageCommitmentMemNV = (PFNGLBUFFERPAGECOMMITMENTMEMNVPROC)
...
static void glad_gl_load_GL_NV_parameter_buffer_object(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glProgramBufferParametersfvNV = (PFNGLPROGRAMBUFFERPARAMETERSFVNVPROC) load(
...
static void glad_gl_load_GL_NV_path_rendering(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glMatrixLoadIdentityEXT = (PFNGLMATRIXLOADIDENTITYEXTPROC) load(userptr, "glMatrixLoadIdentityEXT");
    glad_glMatrixLoadTranspose3x3fNV = (PFNGLMATRIXLOADTRANSPOSE3X3FNVPROC)
            load(userptr, "glMatrixLoadTranspose3x3fNV");
    glad_glMatrixLoadTransposedEXT = (PFNGLMATRIXLOADTRANSPOSEDEXTPROC) load(userptr, "glMatrixLoadTransposedEXT");
    glad_glMatrixLoadTransposefEXT = (PFNGLMATRIXLOADTRANSPOSEFEXTPROC) load(userptr, "glMatrixLoadTransposefEXT");
    glad_glMatrixLoaddEXT = (PFNGLMATRIXLOADDEXTPROC) load(userptr, "glMatrixLoaddEXT");
    glad_glMatrixLoadfEXT = (PFNGLMATRIXLOADFEXTPROC) load(userptr, "glMatrixLoadfEXT");
    ...
    glad_glMatrixMultTranspose3x3fNV = (PFNGLMATRIXMULTTRANSPOSE3X3FNVPROC)
            load(userptr, "glMatrixMultTranspose3x3fNV");
    glad_glMatrixMultTransposedEXT = (PFNGLMATRIXMULTTRANSPOSEDEXTPROC) load(userptr, "glMatrixMultTransposedEXT");
    glad_glMatrixMultTransposefEXT = (PFNGLMATRIXMULTTRANSPOSEFEXTPROC) load(userptr, "glMatrixMultTransposefEXT");
    glad_glMatrixMultdEXT = (PFNGLMATRIXMULTDEXTPROC) load(userptr, "glMatrixMultdEXT");
    glad_glMatrixMultfEXT = (PFNGLMATRIXMULTFEXTPROC) load(userptr, "glMatrixMultfEXT");
    ...
    glad_glPathMemoryGlyphIndexArrayNV = (PFNGLPATHMEMORYGLYPHINDEXARRAYNVPROC) load(
...
static void glad_gl_load_GL_NV_shader_buffer_load(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glGetBufferParameterui64vNV = (PFNGLGETBUFFERPARAMETERUI64VNVPROC)
            load(userptr, "glGetBufferParameterui64vNV");
    ...
    glad_glMakeNamedBufferResidentNV = (PFNGLMAKENAMEDBUFFERRESIDENTNVPROC)
            load(userptr, "glMakeNamedBufferResidentNV");
...
static void glad_gl_load_GL_NV_shading_rate_image(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glShadingRateImageBarrierNV = (PFNGLSHADINGRATEIMAGEBARRIERNVPROC)
            load(userptr, "glShadingRateImageBarrierNV");
    glad_glShadingRateImagePaletteNV = (PFNGLSHADINGRATEIMAGEPALETTENVPROC)
            load(userptr, "glShadingRateImagePaletteNV");
...
static void glad_gl_load_GL_NV_texture_multisample(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glTextureImage2DMultisampleNV = (PFNGLTEXTUREIMAGE2DMULTISAMPLENVPROC) load(
    ...
    glad_glTextureImage3DMultisampleNV = (PFNGLTEXTUREIMAGE3DMULTISAMPLENVPROC) load(
...
static void glad_gl_load_GL_NV_timeline_semaphore(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glGetSemaphoreParameterivNV = (PFNGLGETSEMAPHOREPARAMETERIVNVPROC)
...
static void glad_gl_load_GL_NV_transform_feedback(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glTransformFeedbackVaryingsNV = (PFNGLTRANSFORMFEEDBACKVARYINGSNVPROC) load(
...
static void glad_gl_load_GL_NV_transform_feedback2(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glResumeTransformFeedbackNV = (PFNGLRESUMETRANSFORMFEEDBACKNVPROC)
            load(userptr, "glResumeTransformFeedbackNV");
}
...
static void glad_gl_load_GL_NV_vdpau_interop(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glVDPAURegisterVideoSurfaceNV = (PFNGLVDPAUREGISTERVIDEOSURFACENVPROC) load(
...
static void glad_gl_load_GL_NV_vdpau_interop2(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glVDPAURegisterVideoSurfaceWithPictureStructureNV = (PFNGLVDPAUREGISTERVIDEOSURFACEWITHPICTURESTRUCTURENVPROC)
            load(userptr, "glVDPAURegisterVideoSurfaceWithPictureStructureNV");
}
...
static void glad_gl_load_GL_NV_vertex_program(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glGetVertexAttribPointervNV = (PFNGLGETVERTEXATTRIBPOINTERVNVPROC)
            load(userptr, "glGetVertexAttribPointervNV");
    ...
    glad_glRequestResidentProgramsNV = (PFNGLREQUESTRESIDENTPROGRAMSNVPROC)
            load(userptr, "glRequestResidentProgramsNV");
...
static void glad_gl_load_GL_NV_video_capture(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glGetVideoCaptureStreamdvNV = (PFNGLGETVIDEOCAPTURESTREAMDVNVPROC)
            load(userptr, "glGetVideoCaptureStreamdvNV");
    glad_glGetVideoCaptureStreamfvNV = (PFNGLGETVIDEOCAPTURESTREAMFVNVPROC)
            load(userptr, "glGetVideoCaptureStreamfvNV");
    glad_glGetVideoCaptureStreamivNV = (PFNGLGETVIDEOCAPTURESTREAMIVNVPROC)
            load(userptr, "glGetVideoCaptureStreamivNV");
...
static void glad_gl_load_GL_OES_fixed_point(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glConvolutionParameterxvOES = (PFNGLCONVOLUTIONPARAMETERXVOESPROC)
            load(userptr, "glConvolutionParameterxvOES");
    ...
    glad_glGetTexLevelParameterxvOES = (PFNGLGETTEXLEVELPARAMETERXVOESPROC)
            load(userptr, "glGetTexLevelParameterxvOES");
...
static void glad_gl_load_GL_SGIS_pixel_texture(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glPixelTexGenParameterfSGIS = (PFNGLPIXELTEXGENPARAMETERFSGISPROC)
            load(userptr, "glPixelTexGenParameterfSGIS");
    glad_glPixelTexGenParameterfvSGIS = (PFNGLPIXELTEXGENPARAMETERFVSGISPROC) load(
        userptr, "glPixelTexGenParameterfvSGIS");
    glad_glPixelTexGenParameteriSGIS = (PFNGLPIXELTEXGENPARAMETERISGISPROC)
            load(userptr, "glPixelTexGenParameteriSGIS");
...
static void glad_gl_load_GL_SGIX_fragment_lighting(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glFragmentColorMaterialSGIX = (PFNGLFRAGMENTCOLORMATERIALSGIXPROC)
            load(userptr, "glFragmentColorMaterialSGIX");
    ...
    glad_glGetFragmentMaterialfvSGIX = (PFNGLGETFRAGMENTMATERIALFVSGIXPROC)
            load(userptr, "glGetFragmentMaterialfvSGIX");
    glad_glGetFragmentMaterialivSGIX = (PFNGLGETFRAGMENTMATERIALIVSGIXPROC)
            load(userptr, "glGetFragmentMaterialivSGIX");
...
static void glad_gl_load_GL_SGI_color_table(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glGetColorTableParameterfvSGI = (PFNGLGETCOLORTABLEPARAMETERFVSGIPROC) load(
        userptr, "glGetColorTableParameterfvSGI");
    glad_glGetColorTableParameterivSGI = (PFNGLGETCOLORTABLEPARAMETERIVSGIPROC) load(
...
static void glad_gl_load_GL_SUN_triangle_list(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glReplacementCodePointerSUN = (PFNGLREPLACEMENTCODEPOINTERSUNPROC)
            load(userptr, "glReplacementCodePointerSUN");
...
static void glad_gl_load_GL_SUN_vertex(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glColor4fNormal3fVertex3fvSUN = (PFNGLCOLOR4FNORMAL3FVERTEX3FVSUNPROC) load(
    ...
    glad_glReplacementCodeuiTexCoord2fNormal3fVertex3fSUN = (PFNGLREPLACEMENTCODEUITEXCOORD2FNORMAL3FVERTEX3FSUNPROC)
            load(userptr, "glReplacementCodeuiTexCoord2fNormal3fVertex3fSUN");
    glad_glReplacementCodeuiTexCoord2fNormal3fVertex3fvSUN = (PFNGLREPLACEMENTCODEUITEXCOORD2FNORMAL3FVERTEX3FVSUNPROC)
            load(userptr, "glReplacementCodeuiTexCoord2fNormal3fVertex3fvSUN");
...
static int glad_gl_find_extensions_gl(void) {
    ...
    GLAD_GL_AMD_framebuffer_sample_positions = glad_gl_has_extension(exts, exts_i,
    ...
    GLAD_GL_AMD_seamless_cubemap_per_texture = glad_gl_has_extension(exts, exts_i,
    ...
    GLAD_GL_AMD_vertex_shader_viewport_index = glad_gl_has_extension(exts, exts_i,
    ...
    GLAD_GL_ARB_robust_buffer_access_behavior = glad_gl_has_extension(exts, exts_i,
    ...
    GLAD_GL_ARB_seamless_cubemap_per_texture = glad_gl_has_extension(exts, exts_i,
    ...
    GLAD_GL_ARB_shader_storage_buffer_object = glad_gl_has_extension(exts, exts_i,
                                                                     "GL_ARB_shader_storage_buffer_object");
    GLAD_GL_ARB_shader_subroutine = glad_gl_has_extension(exts, exts_i, "GL_ARB_shader_subroutine");
    GLAD_GL_ARB_shader_texture_image_samples = glad_gl_has_extension(exts, exts_i,
    ...
    GLAD_GL_ARB_texture_mirror_clamp_to_edge = glad_gl_has_extension(exts, exts_i,
    ...
    GLAD_GL_ARB_transform_feedback_instanced = glad_gl_has_extension(exts, exts_i,
    ...
    GLAD_GL_EXT_multiview_texture_multisample = glad_gl_has_extension(exts, exts_i,
    ...
    GLAD_GL_INTEL_conservative_rasterization = glad_gl_has_extension(exts, exts_i,
    ...
    GLAD_GL_KHR_robust_buffer_access_behavior = glad_gl_has_extension(exts, exts_i,
    ...
    GLAD_GL_KHR_texture_compression_astc_hdr = glad_gl_has_extension(exts, exts_i,
                                                                     "GL_KHR_texture_compression_astc_hdr");
    GLAD_GL_KHR_texture_compression_astc_ldr = glad_gl_has_extension(exts, exts_i,
    ...
    GLAD_GL_NV_robustness_video_memory_purge = glad_gl_has_extension(exts, exts_i,
                                                                     "GL_NV_robustness_video_memory_purge");
    GLAD_GL_NV_sample_locations = glad_gl_has_extension(exts, exts_i, "GL_NV_sample_locations");
    GLAD_GL_NV_sample_mask_override_coverage = glad_gl_has_extension(exts, exts_i,
    ...
    GLAD_GL_NV_uniform_buffer_unified_memory = glad_gl_has_extension(exts, exts_i,
