...
void ClippingHelperImplementation::normalize(float values[6][4], const int plane) {
    const float magnitude = MathHelper::sqrt_float(values[plane][0] * values[plane][0] +
                                                   values[plane][1] * values[plane][1] +
                                                   values[plane][2] * values[plane][2]);
    values[plane][0] /= magnitude;
    values[plane][1] /= magnitude;
    values[plane][2] /= magnitude;
    values[plane][3] /= magnitude;
}

void ClippingHelperImplementation::init() {
