...
#ifndef MCPORT_KEYBOARD_H
#define MCPORT_KEYBOARD_H
...
namespace lwjgl {
    namespace Keyboard {
        ...
        // from https://github.com/LWJGL/lwjgl/blob/e7f46b99e2dafde0058126095b14cc758b32ae28/src/java/org/lwjgl/input/Keyboard.java
        enum Key {
            KEY_NONE = 0x00,
